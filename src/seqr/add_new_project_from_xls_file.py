...
commands = [
    ...
    "python3 -u manage.py convert_xls_to_ped --xls '%(xls)s' --ped %(project_id)s.ped ",
    "python3 -u manage.py add_individuals_to_project  %(project_id)s %(case_review)s --ped %(project_id)s.ped ",
    ...
    "python3 -u manage.py add_individuals_to_phenotips %(project_id)s --ped %(project_id)s.ped ",
