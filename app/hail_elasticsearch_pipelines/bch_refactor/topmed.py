...
def get_topmed(partitions : int = None,namenode:str = ""):
    ...
    ht = import_vcf("hdfs://" + namenode + "/user/hadoop/data/bravo-dbsnp-all.removed_chr_prefix.liftunder_GRCh37.vcf.gz","37","topmed",min_partitions=partitions,force_bgz=True)
    return ht
