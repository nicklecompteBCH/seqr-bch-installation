...
MPC_VDS_PATHS = {
    '37': 's3://seqr-resources/GRCh37/MPC/fordist_constraint_official_mpc_values.vds',
    '38': 's3://seqr-resources/GRCh38/MPC/fordist_constraint_official_mpc_values.liftover.GRCh38.vds',
}
