...
EXOME_COVERAGE_KEYTABLE_PATH = {
    "37": "s3://seqr-resources/GRCh37/gnomad/coverage/exome_coverage.kt",
    "38": "s3://seqr-resources/GRCh38/gnomad/coverage/exome_coverage.kt",
}

GENOME_COVERAGE_KEYTABLE_PATH = {
    "37": "s3://seqr-resources/GRCh37/gnomad/coverage/genome_coverage.kt",
    "38": "s3://seqr-resources/GRCh38/gnomad/coverage/genome_coverage.kt",
}
