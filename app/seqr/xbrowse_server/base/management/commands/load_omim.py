...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        print("Loaded %s genes, %s mim ids, and %s phenotypes" % ( len(gene_id_to_mim_id), len(gene_mim_id_to_phenotypes), sum(len(v) for k, v in list(gene_mim_id_to_phenotypes.items()))))
