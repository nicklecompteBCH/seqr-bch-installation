...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        # if not settings.!EAD_VIZ_BAM_PATH or not settings.!EAD_VIZ_BAM_PATH.startswith("http"):
        #     parser.exit("settings.!EAD_VIZ_BAM_PATH is not a url: " + settings.!EAD_VIZ_BAM_PATH)
