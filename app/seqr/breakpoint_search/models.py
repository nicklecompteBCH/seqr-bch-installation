...
class Breakpoint(models.Model):
    ...
    individual = models.ForeignKey(Individual, null=False,on_delete=models.PROTECT)
...
class BreakpointMetaData(models.Model):
    breakpoint = models.ForeignKey(Breakpoint, null=False,on_delete=models.PROTECT)
