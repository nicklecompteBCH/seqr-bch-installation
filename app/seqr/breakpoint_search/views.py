...
def breakpoint_search(request, project_id, family_id):
    ...
    bam_file_paths = dict((ind.indiv_id, ind.bam_file_path) for ind in family.get_individuals())
    #dict((ind.indiv_id, os.path.join(settings.!EAD_VIZ_BAM_PATH,ind.bam_file_path)) for ind in family.get_individuals())
